module "ec2" {
  source = "https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git?ref=v4.1.4"
...
module "sg" {
  source = "https://github.com/terraform-aws-modules/terraform-aws-security-group.git?ref=v4.13.1"
